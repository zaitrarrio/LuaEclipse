...
public class LuaTemplateSourceViewerConfiguration extends LuaSourceViewerConfiguration {

	private boolean fConfigureFormatter;

	public LuaTemplateSourceViewerConfiguration(IColorManager colorManager, IPreferenceStore preferenceStore, ITextEditor editor,
