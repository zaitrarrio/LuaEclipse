...
public class DLTKObjectFactory {
	...
	public static boolean register(LuaState L) {
		...
		NamedJavaFunction[] functions = new NamedJavaFunction[] {
				...
				// LuaModuleDeclaration
				new NamedJavaFunction() {
					@Override
					public int invoke(LuaState l) {
						if (l.getTop() == 2) {
							l.pushJavaObject(new LuaModuleDeclaration(l.checkInteger(1), l.checkBoolean(2)));
						} else {
							l.pushJavaObject(new LuaModuleDeclaration(l.checkInteger(1)));
						}
						return 1;
					}
				...
				new NamedJavaFunction() {
					...
					@Override
					public int invoke(LuaState l) {
						LuaModuleDeclaration mod = l.checkJavaObject(1, LuaModuleDeclaration.class);
